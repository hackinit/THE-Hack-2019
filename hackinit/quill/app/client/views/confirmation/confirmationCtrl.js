angular.module('reg')
  .controller('ConfirmationCtrl', [
    ...
    'UserService',
    '$http',
    function($scope, $rootScope, $state, currentUser, Utils, UserService, $http){
      ...
      function _uploadResume() {
        ...
        if (files.length == 0) {
          ...
          $.ajax({
            type: 'PUT',
            url: 'https://api.thehack.org.cn/s3/upload/confirmation/hackinit/' + $scope.user._id + '_resume' + _getExtension(resume.name),
            data: formData,
            processData: false,
            contentType: false,
